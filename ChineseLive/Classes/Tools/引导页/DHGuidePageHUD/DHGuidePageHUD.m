        ...
        */
        ...
        for (int i=0; i<imageNameArray.count; i++) {
            ...
            if (i == imageNameArray.count-1 && isHidden == NO) {
                ...
                UIButton *startButton = [[UIButton alloc]initWithFrame:CGRectMake(DDScreenW*0.3, DDScreenH*0.72, DDScreenW*0.4, DDScreenH*0.068)];
                
                
//                UIButton *startButton = [[UIButton alloc]init];

                [startButton setTitle:@"点击进入" forState:UIControlStateNormal];
//                [startButton setBackgroundColor:DDColor(21, 162, 252)];
//                [startButton setTitleColor:[UIColor colorWithRed:164/255.0 green:201/255.0 blue:67/255.0 alpha:1.0] forState:UIControlStateNormal];
                [startButton.titleLabel setFont:[UIFont systemFontOfSize:22]];
