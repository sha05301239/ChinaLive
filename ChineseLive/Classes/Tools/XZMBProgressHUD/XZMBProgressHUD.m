...
//  WaterProject
//
//  Created by sha xianding on 2018/4/23.
//  Copyright © 2018年 鼎. All rights reserved.
//

#import "XZMBProgressHUD.h"
...
+(void)hideAlert{
    dispatch_async(dispatch_get_main_queue(), ^{
        MBProgressHUD *hud = [XZMBProgressHUD HUDForView:gloomyView];
#if 1
